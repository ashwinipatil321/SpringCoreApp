...
import com.spring.controller.EmployeeAutowiredByTypeService;
import com.spring.controller.EmployeeService;

public class App 
{
    public static void main( String[] args )
    {
ClassPathXmlApplicationContext ctx = new ClassPathXmlApplicationContext("autowire.xml");
